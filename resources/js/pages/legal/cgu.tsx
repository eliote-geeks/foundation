...
export default function CGU() {
    return (
        <>
            <Head title="Conditions d'utilisation — Fondation TITI" />
            <LegalLayout title="Conditions générales d'utilisation" lastUpdated="19 mai 2026">
                <LegalSection title="Objet">
                    <LegalP>
                        Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de la plateforme en ligne de la Fondation TITI, accessible à l'adresse fondation-titi.org.
                    </LegalP>
                    <LegalP>
                ...
                <LegalSection title="Inscription et compte utilisateur">
                    ...
                    <LegalList items={[
                        ...
                        'Notifier immédiatement la Fondation TITI de toute utilisation non autorisée de son compte',
                ...
                <LegalSection title="Participation aux événements et concours">
                    <LegalP>
                        La participation aux événements et concours organisés par la Fondation TITI est soumise à des conditions particulières communiquées lors de chaque événement. La Fondation TITI se réserve le droit d'exclure tout participant ne respectant pas ces conditions.
                    </LegalP>
                </LegalSection>

                <LegalSection title="Dons et contributions">
                    <LegalP>
                        Les dons effectués via la plateforme sont définitifs et non remboursables, sauf en cas d'erreur technique dûment constatée. La Fondation TITI s'engage à utiliser les fonds reçus conformément à sa mission sociale et à ses engagements déclarés.
                    </LegalP>
                </LegalSection>

                <LegalSection title="Suspension et résiliation">
                    <LegalP>
                        La Fondation TITI se réserve le droit de suspendre ou de supprimer tout compte utilisateur en cas de violation des présentes CGU, sans préavis ni indemnité. L'utilisateur peut également supprimer son compte à tout moment depuis les paramètres de son profil.
                    </LegalP>
                </LegalSection>

                <LegalSection title="Modification des CGU">
                    <LegalP>
                        La Fondation TITI se réserve le droit de modifier les présentes CGU à tout moment. Les modifications entrent en vigueur dès leur publication sur la plateforme. L'utilisation continue de la plateforme après modification vaut acceptation des nouvelles CGU.
                    </LegalP>
                </LegalSection>
