...
const PAYMENT_METHODS = [
    { name: 'MTN Mobile Money', icon: 'bi-phone-fill', color: '#FFCC00', bg: '#FFF8D6' },
    { name: 'Orange Money', icon: 'bi-phone-fill', color: '#FF6600', bg: '#FFF0E6' },
    { name: 'Carte bancaire', icon: 'bi-credit-card-2-front', color: '#1A56DB', bg: '#E8EFFE' },
    { name: 'Virement', icon: 'bi-bank', color: '#4D8A3C', bg: '#E8F4E5' },
];
            ...
            <Container>
                ...
                <Row className="g-4 mb-5 position-relative">
                    ...
                    <div
                        ...
                        style={{ top: 40, left: '12.5%', right: '12.5%', height: 1, background: '#E5E7EB', zIndex: 0 }}
                    />
                    {STEPS.map((step, i) => (
                        <Col md={6} lg={3} key={i} style={{ position: 'relative', zIndex: 1 }}>
                            <div className="text-center">
                                ...
                                <h5 className="fw-bold mb-2" style={{ color: '#1A3209' }}>{step.title}</h5>
                ...
                >
                    <Row className="align-items-center g-4">
                        <Col md={5}>
                            <h4 className="fw-bold mb-2" style={{ color: '#1A3209' }}>
                                    ...
                                    <Col xs={6} key={i}>
                                        ...
                                        >
                                            <div
                                                ...
                                                style={{ width: 34, height: 34, background: '#FFFFFF', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}
                                            >
                                                <i className={pm.icon} style={{ color: pm.color, fontSize: '1rem' }}></i>
                                            </div>
                                            <span className="fw-semibold" style={{ color: '#1A3209', fontSize: 'clamp(0.72rem, 1.8vw, 0.875rem)', lineHeight: 1.2 }}>{pm.name}</span>
                                        </div>
                                    </Col>
                                ))}
                            </Row>
